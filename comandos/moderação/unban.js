...
exports.run = async (client, message, args) => {
  ...
  let erro = new Discord.MessageEmbed()
    ...
    .setColor("#2f3136")
    .setDescription(
      `<:pasta:727531432427388999> Informação deste erro: \n\`O comando de unban é utilizado para debanir o user de seu servidor! Basta usar ${prefix}unban <@menção> <motivo>\` \n\n<:moderation_hammer:727243867711209582> Permisão do comando: \n\`BAN_MEMBERS\``
    );
  ...
  if (membro === message.member)
    return message.reply(
      `<:close:735574187204280360> | Eu não posso autounbanir você mesmo!`
    );
  ...
  let banido = new Discord.MessageEmbed()
    .setTitle(`<:ban:735582739545456731> unBanimento!`)
    .setColor("#2f3136")
    .setDescription(
